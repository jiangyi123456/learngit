...
decoder.add(Dense(19,activation='sigmoid',kernel_regularizer=regularizers.l2(0.015)))   #　　,activity_regularizer=regularizers.l1(0.001)  ,kernel_regularizer=regularizers.l2(0.002)
...
if save_weights_flag:
    ...
    hist = decoder.fit([x_train,x_train1], y_train,validation_split=0.2,
              epochs=600,
